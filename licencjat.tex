...
%Udało nam się zebrać oraz przedstawić część matematyczną po to by by w dalszym etapie móc porównać ją do ujęcia statystycznego. Dzięki temu możliwe było zauważenie róznić chociażby w interpretacji porządku nieliniowego. W ujęciu matematycznym reprezentuje je relacja częściowego porządku, której to graficznie przedstawienie reprezentuje dendryt...
