...
\item Niech $x,y \in X$ oraz niech $xSy$. {\color{red} Dokończyć} %TODO dokończyć (bardzo proste)
...
\item Element maksymalny $x_M$ w zbiorze ma pojedynczego sąsiada. {\color{red} Dokończyć} %TODO dokończyć
...
x_m \leq x \leq x_M.
$$
Zatem albo $x_m$ jest sąsiadem $x$ albo istnieje $y_1$ taki, że $y \leq x$. {\color{red} Dokończyć} %TODO dokończyć
Analogicznie albo $x_M$ jest sąsiadem $x$ albo istnieje $z_1$ taki, że $x \leq z_1$. {\color{red} Dokończyć} %TODO dokończyć
...
\begin{figure}[h]
\centering
%\includegraphics[width=1\textwidth]{zbior2} %TODO missing in repo
